...
STILL_ONE_LANGUAGE: dict[str, int] = {
    ...
    "themis/estimation/general_id.py": 20,
    "themis/estimation/iv.py": 22,
    "themis/estimation/joint.py": 5,
    "themis/estimation/longitudinal.py": 2,
    "themis/estimation/measurement.py": 40,
    "themis/estimation/mediation.py": 3,
    "themis/estimation/missing_recovery.py": 3,
    ...
    "themis/estimation/outcome_error.py": 9,
    "themis/estimation/proximal.py": 3,
    "themis/estimation/regression_calibration.py": 13,
    "themis/estimation/scm_counterfactual.py": 1,
    "themis/estimation/selection.py": 5,
