...
STILL_ONE_LANGUAGE: dict[str, int] = {
    ...
    "themis/estimation/general_id.py": 10,
    "themis/estimation/iv.py": 20,
    "themis/estimation/joint.py": 4,
    "themis/estimation/longitudinal.py": 2,
    "themis/estimation/measurement.py": 33,
    ...
    "themis/estimation/selection.py": 4,
