...
def test_manski_binary_returns_bounds():
    b = attempt_manski_natural(_effect(), outcome_is_binary=True)
...
def test_manski_returns_none_on_continuous_outcome():
    ...
    b = attempt_manski_natural(_effect(), outcome_is_binary=False)
    assert b is None
...
def test_manski_returns_none_on_conditional_query():
    ...
    b = attempt_manski_natural(_effect(given=given), outcome_is_binary=True)
    assert b is None
...
def test_manski_handles_intervention_value_false():
    ...
    b = attempt_manski_natural(
        _effect(intervention_val=False), outcome_is_binary=True
    )
    assert b is not None
...
def test_manski_handles_target_value_false():
    ...
    b = attempt_manski_natural(
        _effect(target_val=False), outcome_is_binary=True
    )
    assert b is not None
