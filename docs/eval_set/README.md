...
> - v2.2: +case 25 with F21 (Phase 7.1 numeric estimation)
> - v2.3: +case 26/27/28 with F22 (Phase 7+8 numeric / sensitivity)
...
```json
{
  ...
  "gold_query_kind": "cause | assoc | effect | identify | probability | counterfactual | causation | scm_counterfactual | counterfactual_conjunction | proximal_effect"
}
```
